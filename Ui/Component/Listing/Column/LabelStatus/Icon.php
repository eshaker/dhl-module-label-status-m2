...
namespace Dhl\LabelStatus\Ui\Component\Listing\Column\LabelStatus;
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (empty($item[$fieldname])) {
                    ...
                    $src = $this->assetRepo->getUrl('Dhl_LabelStatus::images/icon_failed.png');
                    $alt = $this->escaper->escapeHtml(__('DHL Label Status (failed)'));
                    $title = $this->escaper->escapeHtml(__($item[$fieldname]));
                    $item[$fieldname] = sprintf($format, $src, $alt, $title);
                } else {
                    $src = $this->assetRepo->getUrl('Dhl_LabelStatus::images/icon_incomplete.png');
